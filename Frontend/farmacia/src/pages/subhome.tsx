...
// estos son los componentes dinámicos que vamos a crear
import TopMedicamentos     from "../components/elementosHome/TopMedicamentos";
import TopCategories       from "../components/elementosHome/TopCategories";
...
export default function Home() {
  ...
  return (
    <section class="min-h-screen flex flex-col">
      ...
      {/* ————— Aquí van las secciones dinámicas en el orden acordado ————— */}
      <TopMedicamentos />
      <TopCategories />
